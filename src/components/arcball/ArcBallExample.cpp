...
namespace Magnum
{
  ...
  public:
    explicit VisualizationDrawable(Object3D &object,
                                   ...
                                   SceneGraph::DrawableGroup3D &drawables) : SceneGraph::Drawable3D{object, &drawables}, _shader(shader),
                                                                             _mesh(mesh) {}
  ...
  ArcBallExample::ArcBallExample(const Arguments &arguments) : Platform::Application{arguments, NoCreate}
  {
    /* Setup window */
    {
