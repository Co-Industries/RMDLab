...
namespace Magnum
{
    ...
    {
    public:
        explicit Simulation(Scene3D &scene, SceneGraph::DrawableGroup3D &drawables, UnsignedInt atomCount, bool &drawOctreeBounds);
        void updateAtoms();
        void updateOctree();
    ...
    protected:
        ...
        Containers::Array<OctreeInstanceData> _octreeInstanceData;
