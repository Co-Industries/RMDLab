...
namespace Magnum
{
  namespace Examples
  {
    ...
    {
    public:
      explicit Octree(const Arguments &arguments);
    ...
    Octree::Octree(const Arguments &arguments) : Platform::Application{arguments, NoCreate}
    {
      ...
      /* Setup window and parameters */
      {
        ...
        Configuration conf;
        /*CHANGE setTitle("Magnum Octree") = .exe window title*/
        conf.setTitle("Magnum Octree")
    ...
    void Octree::collisionDetectionAndHandlingBruteForce()
    {
    ...
    void Octree::collisionDetectionAndHandlingUsingOctree()
    {
    ...
    void Octree::checkCollisionWithSubTree(const OctreeNode &node,
    ...
    void Octree::drawTreeNodeBoundingBoxes()
    {
    ...
    void Octree::viewportEvent(ViewportEvent &event)
    {
    ...
    void Octree::keyPressEvent(KeyEvent &event)
    {
    ...
    void Octree::mousePressEvent(MouseEvent &event)
    {
    ...
    void Octree::mouseReleaseEvent(MouseEvent &)
    {
    ...
    void Octree::mouseMoveEvent(MouseMoveEvent &event)
    {
      if (!event.buttons())
        return;
    ...
    void Octree::mouseScrollEvent(MouseScrollEvent &event)
    {
...
MAGNUM_APPLICATION_MAIN(Magnum::Examples::Octree)