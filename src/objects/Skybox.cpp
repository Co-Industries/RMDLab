...
namespace Magnum
{
        ...
        Skybox::Skybox(Scene3D &scene, SceneGraph::DrawableGroup3D &drawables) : _scene(scene), _drawables(drawables)
        {
                ...
                GL::Buffer vertices;
                for (Vector3 vertex : _mutableMeshData.positions3DAsArray())
                {
